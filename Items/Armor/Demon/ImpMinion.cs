    ...
    public class ImpMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (ownerMinionAttackTargetNPC2 != null && ownerMinionAttackTargetNPC2.CanBeChasedBy(this, false))
            {
                ...
                if (((Vector2.Distance(projectile.Center, vector) > num14 && num14 < num10) || !flag) &&
            ...
            if (!flag)
            {
                for (int l = 0; l < 200; l++)
                {
                    ...
                    if (nPC2.CanBeChasedBy(this, false))
                    {
                        ...
                        if (((Vector2.Distance(projectile.Center, vector) > num15 && num15 < num10) || !flag) &&
                            Collision.CanHitLine(projectile.position, projectile.width, projectile.height,
            ...
            else
            {
                ...
                {
                    if (Main.projectile[m].active && Main.projectile[m].owner == projectile.owner &&
        ...
        public override bool PreAI()
        {
            ...
            {
                int num25 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 6, 0f, 0f, 100, default(Color), 2f);
