    ...
    public class Dynabomb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.alpha <= 0)
            {
                ...
                {
                    int num108 = Dust.NewDust(projectile.position, projectile.width, projectile.height,
                        mod.DustType<InfinityOverloadO>(), 0f, 0f, 0, default(Color), 1f);
            ...
            if (projectile.alpha > 0)
            {
                ...
                if (projectile.alpha < 0)
                {
                    ...
                    while ((float) num110 < num109)
                    {
                        ...
                        vector14 += -Vector2.UnitY.RotatedBy((double) ((float) num110 * (6.28318548f / num109)),
                                        default(Vector2)) * new Vector2(1f, 4f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num86 = Dust.NewDust(position, num84, height3, mod.DustType<InfinityOverloadO>(), 0f, 0f, 100,
                    default(Color), 1);
            ...
            {
                int num88 = Dust.NewDust(position, num84, height3, mod.DustType<InfinityOverloadO>(), 0f, 0f, 200,
                    default(Color), 1);
                ...
                num88 = Dust.NewDust(position, num84, height3, mod.DustType<InfinityOverloadO>(), 0f, 0f, 100,
                    default(Color), 1);
                Main.dust[num88].position = projectile.Center +
                                            (Vector2.UnitY.RotatedByRandom(3.1415927410125732) *
                                             (float) Main.rand.NextDouble() * (float) num84 / 2f);
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, mod.DustType<InfinityOverloadO>(), 0f, 0f, 0,
                    default(Color), 1);
            ...
            {
                int num92 = Dust.NewDust(position, num84, height3, mod.DustType<InfinityOverloadO>(), 0f, 0f, 0,
                    default(Color), 1);
