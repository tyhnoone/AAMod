            ...
            ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num120 = 0; num120 < 3; num120++)
            {
                vector2 = player.Center +
                          new Vector2((float) (-(float) Main.rand.Next(0, 401) * player.direction), -600f);
                ...
                Projectile.NewProjectile(vector2.X, vector2.Y, speedX5, speedY6, mod.ProjectileType("StarWrathEXP"),
                    damage * 3 / 2, knockBack, Main.myPlayer);
            }
