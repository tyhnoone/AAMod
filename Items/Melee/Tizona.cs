...
namespace AAMod.Items.Melee
{
    public class Tizona : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.useAnimation =
                26; //The time span of the using animation of the weapon, suggest set it the same as useTime.
            item.useStyle =
                1; //The use style of weapon, 1 for swinging, 2 for drinking, 3 act like shortsword, 4 for use like life crystal, 5 for use staffs or guns
