...
namespace AAMod.Items.Melee
{
    public class Firestorm : ModItem
    {
            ...
            ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                Vector2 perturbedSpeed =
                    new Vector2(speedX * 4, speedY * 4).RotatedBy(MathHelper.Lerp(-rotation, rotation,
        ...
        public override void MeleeEffects(Player player, Rectangle hitbox)
        {
            ...
            {
                Dust.NewDust(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, 6, 0f, 0f, 46,
