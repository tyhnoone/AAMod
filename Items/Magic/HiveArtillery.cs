    ...
    public class HiveArtillery : ModItem
    {
            ...
            ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int num164 = 0; num164 < num163; num164++)
            {
                ...
                int num167 = Projectile.NewProjectile(vector2.X, vector2.Y, num165, num166, player.beeType(),
                    player.beeDamage(damage), player.beeKB(knockBack), player.whoAmI, 0f, 0f);
