    ...
    internal class Prismshot : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int num443 = 0; num443 < 2; num443++)
            {
                ...
                projectile.alpha = 255;
                int num444 = Dust.NewDust(vector31, 1, 1, mod.DustType<Dusts.HallowedDust>(), 0f, 0f, 0, default(Color),
                    1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num585 = 0; num585 < 20; num585++)
            {
                int num586 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.InfinityOverloadB>(), 0f, 0f, 100, AAColor.Hallow, 2f);
