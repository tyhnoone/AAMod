        ...
        public override bool CanUseItem(Player player)
        {
            if (Main.dayTime)
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The claw just lays limp in your hand.", Color.Purple.R, Color.Purple.G,
            ...
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The Retriever is still trying to grab you", Color.Purple.R, Color.Purple.G,
                        Color.Purple.B, false);
                return false;
            }
