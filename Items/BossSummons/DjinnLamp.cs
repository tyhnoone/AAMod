        ...
        public override bool CanUseItem(Player player)
        {
            if (!Main.dayTime)
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The lamp shimmers in the moonlight, yet does nothing", Color.Goldenrod.R,
                        Color.Goldenrod.G, Color.Goldenrod.B, false);
                return false;
            }
            ...
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The lamp spits out sand as you rub it", Color.Goldenrod.R, Color.Goldenrod.G,
            ...
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("No ammount of rubbing the lamp will save you here", Color.Goldenrod.R,
                        Color.Goldenrod.G, Color.Goldenrod.B, false);
                return false;
            }
