        ...
        public override bool CanUseItem(Player player)
        {
            if (Main.dayTime)
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The bell rings, but nothing happens.", Color.Purple.R, Color.Purple.G,
            ...
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The Raider hears the bell and keeps attempting to kill you", Color.Purple.R,
                        Color.Purple.G, Color.Purple.B, false);
                return false;
            }
