        ...
        public override bool CanUseItem(Player player)
        {
            if (Main.dayTime)
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("Nothing is coming. The creatures of the Mire sleep.", Color.Indigo.R,
                        Color.Indigo.G, Color.Indigo.B, false);
                return false;
            }
            ...
            if (player.GetModPlayer<AAPlayer>(mod).ZoneMire)
            {
                ...
                {
                    if (player.whoAmI == Main.myPlayer)
                        BaseUtility.Chat("The Hydra wants that food.", Color.Indigo.R, Color.Indigo.G, Color.Indigo.B,
                            false);
                    return false;
                }
            ...
            if (player.whoAmI == Main.myPlayer)
                BaseUtility.Chat("Nothing is coming. Now you look dumb holding out this smelly ball of gunk.",
                    Color.Indigo.R, Color.Indigo.G, Color.Indigo.B, false);
            return false;
        }
