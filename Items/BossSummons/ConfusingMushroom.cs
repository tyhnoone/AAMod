        ...
        public override bool CanUseItem(Player player)
        {
            ...
            if (!player.ZoneGlowshroom)
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The mushroom glows, and the smell of it makes you feel loopy.", Color.SkyBlue,
                        false);
                return false;
            }
            ...
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("The Feudal Fungus keeps trying to attack you", Color.SkyBlue, false);
                return false;
            }
