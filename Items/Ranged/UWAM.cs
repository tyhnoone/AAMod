...
namespace AAMod.Items.Ranged
{
    public class UWAM : ModItem
    {
            ...
            ref int type, ref int damage, ref float knockBack)
        {
            ...
            int p1 = Projectile.NewProjectile(vector.X, vector.Y, speedX2, speedY2, type, damage, knockBack,
                player.whoAmI);
            int p2 = Projectile.NewProjectile(vector.X, vector.Y, speedX, speedY, type, damage, knockBack,
                player.whoAmI);
            int p3 = Projectile.NewProjectile(vector.X, vector.Y, speedX3, speedY3, type, damage, knockBack,
                player.whoAmI);
            if (type == 408)
            {
