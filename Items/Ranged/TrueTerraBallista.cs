...
Terra Ballista EX");
            ...
            ref int type, ref int damage, ref float knockBack)
        {
            ...
            Projectile.NewProjectile(vector.X, vector.Y, speedX2, speedY2, mod.ProjectileType("TerraArrow"), damage,
                knockBack, player.whoAmI);
            Projectile.NewProjectile(vector.X, vector.Y, speedX, speedY, mod.ProjectileType("TerraArrow"), damage,
                knockBack, player.whoAmI);
            Projectile.NewProjectile(vector.X, vector.Y, speedX3, speedY3, mod.ProjectileType("TerraArrow"), damage,
                knockBack, player.whoAmI);
            return false;
        }
