...
namespace AAMod.Items.Ranged
{
    public class Skystrike : ModItem
    {
            ...
            ref int type, ref int damage, ref float knockBack)
        {
            ...
            player.itemRotation = (float) Math.Atan2((double) (vector6.Y * (float) player.direction),
                (double) (vector6.X * (float) player.direction));
            ...
            for (int num91 = 0; num91 < num90; num91++)
            {
                ...
                int num93 = Projectile.NewProjectile(vector2.X, vector2.Y, num92, SpeedY, 710, damage, knockBack,
                    player.whoAmI, 0f, 0f);
