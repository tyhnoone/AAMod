            ...
            if(Language.ActiveCulture == GameCulture.English)
                {
                    switch(WorldInfo)
                    {
                        ...
                        return "The choirs of unity hum from the terrarium, and echo across the land...";
            ...
            if(Language.ActiveCulture == GameCulture.English)
                {
                    switch(BossInfo)
                    {
                        ...
                        case "AkumaA11":
                        return "GRAH..! HOW!? HOW COULD I LOSE TO A MERE MORTAL TERRARIAN?! Hmpf...fine kid, you win, fair and square. Heere's your reward.";
                        case "AkumaA12":
                        ...
                        case "YamataHead18":
                        return "GRAAAAAAAAAAAAAAAAAAAH STAHP MOOOOOOOOVIIIIIIING!!!!!";
                        case "YamataHead19":
