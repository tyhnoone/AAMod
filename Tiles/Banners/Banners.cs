        ...
        public static string GetBannerName(int frameX, bool spaces = false)
        {
            ...
            switch (style)
            {
                case 1:
                    ...
                    break;
                case 2:
                    dropName = "Feral Monster";
                    break;
                case 3:
                    dropName = "Mini Djinn";
                    break;
                case 4:
                    dropName = "Blaze Phoenix";
                    break;
                case 5:
                    dropName = "Chaotic Dawn";
                    break;
                case 6:
                    dropName = "Dragron";
                    break;
                case 7:
                    dropName = "Flame brute";
                    break;
                case 8:
                    dropName = "Flamespitter";
                    break;
                case 9:
                    dropName = "Infernal Slime";
                    break;
                case 10:
                    dropName = "Inferno Salamander";
                    break;
                case 11:
                    dropName = "Wyrm";
                    break;
                ...
                case 22:
                    ...
                    break;
                case 23:
                    dropName = "Chaos Dragon";
                    break;
                case 24:
                    dropName = "Cyber Claw";
                    break;
                case 25:
                    dropName = "Dragon Claw";
                    break;
                case 26:
                    dropName = "Elder Dragon";
                    break;
                case 27:
                    dropName = "Hydra Claw";
                    break;
                case 28:
                    dropName = "Madness Bat";
                    break;
                case 29:
                    dropName = "Madness Slime";
                    break;
                case 30:
                    dropName = "Dimension Diver";
                    break;
                case 31:
                    dropName = "Rift Shark";
                    break;
                ...
                case 34:
                    ...
                    break;
                case 35:
                    dropName = "Terra Deadshot";
                    break;
                case 36:
                    dropName = "Terra Warlock";
                    break;
                case 37:
                    dropName = "Terra Wizard";
                    break;
                case 38:
                    dropName = "Null";
                    break;
            ...
            if (spaces) //fix for display names
            {
                switch (style)
                {
                    ...
                    case 22:
                        ...
                        break;
                    case 28:
                        dropName = "Madness Flier";
                        break;
                    case 30:
                        dropName = "Trench Diver";
                        break;
                    case 31:
                        dropName = "Trench Shark";
                        break;
                    case 32:
                        dropName = "Trench Squid";
                        break;
                    case 33:
                        dropName = "Snow Serpent";
                        break;
                    case 34:
                        dropName = "Terra Knight";
                        break;
                }
            }
