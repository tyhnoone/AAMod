    ...
    public class RadiumOre : ModTile
    {
        ...
        public override bool PreDraw(int x, int y, SpriteBatch spriteBatch)
        {
            ...
            if (Main.dayTime)
            {
                ...
                BaseDrawing.DrawTileTexture(spriteBatch, glowtex, x, y, true, false, false, null,
                    AAGlobalTile.GetRadiumColorBright);
            }
            else
            {
                BaseDrawing.DrawTileTexture(spriteBatch, mod.GetTexture("Tiles/RadiumOreDark"), x, y, true, false,
                    false);
                BaseDrawing.DrawTileTexture(spriteBatch, glowtex, x, y, true, false, false, null,
                    AAGlobalTile.GetDarkmatterColorBright);
            }
            ...
            Main.spriteBatch.Draw(glowtex,
                ...
                new Rectangle(tile.frameX, tile.frameY, 16, height), Main.dayTime ? Color.Yellow : Color.DeepSkyBlue,
