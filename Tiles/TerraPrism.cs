...
namespace AAMod.Tiles
{
    public class TerraPrism : ModTile
    {
        ...
        public override void PostDraw(int x, int y, SpriteBatch sb)
        {
            ...
            BaseDrawing.DrawTileTexture(sb, glowTex, x, y, 16, 16, tile.frameX,
                tile.frameY + (Main.tileFrame[Type] * 54), false, false, false, null, AAGlobalTile.GetTerraColorBright);
        }
