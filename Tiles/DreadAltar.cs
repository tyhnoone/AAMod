    ...
    class DreadAltar : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            for (int num301 = 0; num301 < num3; num301++)
            {
                ...
                {
                    Main.spriteBatch.Draw(MoonTexture, SunVector1, new Rectangle?(source), color, Main.sunCircle,
        ...
        public override void RightClick(int i, int j)
        {
            ...
            {
                if (player.whoAmI == Main.myPlayer)
                    BaseUtility.Chat("WHAT THE HELL ARE YOU DOING?! I'M ALREADY HERE!!!", new Color(45, 46, 70), false);
                return;
            }
            ...
            if (!NPC.AnyNPCs(mod.NPCType("Yamata")) && !NPC.AnyNPCs(mod.NPCType("YamataA")))
            {
                ...
                {
                    if (player.inventory[num66].type == mod.ItemType<Items.BossSummons.DreadRune>() &&
