    ...
    public class BloodyFlare : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] >= 60f)
            {
                ...
                if (!Main.npc[num570].active)
                {
                    ...
                    for (int num572 = 0; num572 < 200; num572 = num3 + 1)
                    {
                        ...
                        {
                            float num573 =
                                Math.Abs(Main.npc[num572].position.X + (float) (Main.npc[num572].width / 2) -
                                         projectile.position.X + (float) (projectile.width / 2)) +
                                Math.Abs(Main.npc[num572].position.Y + (float) (Main.npc[num572].height / 2) -
                ...
                float num574 = 4f;
                Vector2 vector45 = new Vector2(projectile.position.X + (float) projectile.width * 0.5f,
            ...
            for (int num579 = 0; num579 < 5; num579 = num3 + 1)
            {
                ...
                int num582 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType("DiscordLight"), 0f, 0f, 100, Color.Red, 1.3f);
