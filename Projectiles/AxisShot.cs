    ...
    public class AxisShot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                if (projectile.localAI[0] >= 4f)
                {
                    ...
                    {
                        if (Main.projectile[num567].active && Main.projectile[num567].owner == projectile.owner &&
                            Main.projectile[num567].type == 344)
                        {
                            num566++;
                        }
                    ...
                    if (num568 > (float) projectile.damage * 0.1f)
                    {
                        Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f,
                            mod.ProjectileType("AxisSnow"), (int) num568, projectile.knockBack * 0.55f,
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num369 = 4; num369 < 31; num369 = num3 + 1)
            {
                ...
                int num372 =
                    Dust.NewDust(new Vector2(projectile.oldPosition.X - num370, projectile.oldPosition.Y - num371), 8,
                        8, 180, projectile.oldVelocity.X, projectile.oldVelocity.Y, 100, default(Color), 1.2f);
