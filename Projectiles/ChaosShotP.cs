    ...
    public class ChaosShotP : ModProjectile
    {
        ...
        public override void AI()
        {
            for (int dust = 0; dust < 5; dust++)
            {
                int dustId = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f),
                    projectile.width, projectile.height + 5, mod.DustType<Dusts.AkumaADust>(),
                ...
                int dustId3 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f),
                    projectile.width, projectile.height + 5, mod.DustType<Dusts.YamataADust>(),
                    projectile.velocity.X * 0.2f,
                    projectile.velocity.Y * 0.2f, 100, new Color(Main.DiscoR, 0, Main.DiscoB), 1f);
        ...
        public override void Kill(int timeleft)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.velocity.X,
                projectile.velocity.Y, mod.ProjectileType("PerfectChaosE"), projectile.damage, projectile.knockBack,
