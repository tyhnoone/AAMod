...
namespace AAMod.Projectiles.Yamata
{
    public class Moonblow : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num88 = Dust.NewDust(position, num84, height3, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 200,
                    default(Color), 3.7f);
            ...
            {
                int num90 = Dust.NewDust(position, num84, height3, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 0,
                    default(Color), 2.7f);
