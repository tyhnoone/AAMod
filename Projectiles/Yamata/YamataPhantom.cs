...
namespace AAMod.Projectiles.Yamata
{
    class YamataPhantom : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            dust1 = Main.dust[
                Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, projectile.height,
                    mod.DustType<Dusts.YamataADust>(), 0f, 0f, 46, default(Color), 1.381579f)];
