...
namespace AAMod.Projectiles.Yamata
{
    public class Toxibomb : ModProjectile
    {
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                int num469 = Dust.NewDust(new Vector2(projectile.width, projectile.height), projectile.width,
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.velocity.X,
                projectile.velocity.Y, mod.ProjectileType("Toxiboom"), projectile.damage, projectile.knockBack,
