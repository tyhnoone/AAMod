...
namespace AAMod.Projectiles.Zero
{
    public class EventHorizon : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Color color25 = Lighting.GetColor((int) (projectile.position.X + (projectile.width * 0.5)) / 16,
            ...
            projPos = (new Vector2(projectile.width, projectile.height) / 2f) + (Vector2.UnitY * projectile.gfxOffY) -
                      Main.screenPosition; //fuck it
            ...
            Microsoft.Xna.Framework.Rectangle rectangle8 =
                new Microsoft.Xna.Framework.Rectangle(0, 0, texture2D22.Width, 36); //2 and 40
            Vector2 value29 = new Vector2(0f, Main.player[projectile.owner].gfxOffY);
            float rotation24 = projectile.rotation + 3.14159274f;
            Main.spriteBatch.Draw(texture2D22, projectile.Center.Floor() - Main.screenPosition + value29,
                new Microsoft.Xna.Framework.Rectangle?(rectangle8), alpha3, rotation24,
                (rectangle8.Size() / 2f) - (Vector2.UnitY * 4f), projectile.scale, SpriteEffects.None, 0f);
            ...
            if (num230 > 0f)
            {
                ...
                while (num231 + 1f < num230)
                {
                    ...
                    Main.spriteBatch.Draw(texture2D22, vector31 - Main.screenPosition + value29,
                        new Microsoft.Xna.Framework.Rectangle?(rectangle8), alpha3, rotation24,
                        new Vector2(rectangle8.Width / 2, 0f), projectile.scale, SpriteEffects.None, 0f);
            ...
            Main.spriteBatch.Draw(texture2D22, value30 - Main.screenPosition + value29,
                new Microsoft.Xna.Framework.Rectangle?(rectangle8), alpha3, rotation24,
                texture2D22.Frame(1, 1, 0, 0).Top(), projectile.scale, SpriteEffects.None, 0f);
            return false;
        }
        ...
        public override void CutTiles()
        {
            ...
            Utils.PlotTileLine(projectile.Center, projectile.Center + (unit * projectile.localAI[1]),
                projectile.width * projectile.scale, new Utils.PerLinePoint(DelegateMethods.CutTiles));
        }
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            if (Collision.CheckAABBvLineCollision(targetHitbox.TopLeft(), targetHitbox.Size(), projectile.Center,
                projectile.Center + projectile.velocity, 16f * projectile.scale, ref num8))
            {
                return true;
            }
        ...
        {
            Projectile.NewProjectile(target.Center, Vector2.Zero, mod.ProjectileType<Horizon>(), projectile.damage, 0,
