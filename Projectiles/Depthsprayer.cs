        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(8) == 0)
            {
                ...
                int num159 = Dust.NewDust(
                    new Vector2(projectile.position.X + (float) num158, projectile.position.Y + (float) num158),
                    projectile.width - num158 * 2, projectile.height - num158 * 2, mod.DustType<Dusts.HydraDust>(), 0f,
