...
namespace AAMod.Projectiles
{
    public class M79P : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num730 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
            ...
            {
                int num732 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 6, 0f, 0f, 100, default(Color), 3.5f);
                Main.dust[num732].noGravity = true;
                Dust dust = Main.dust[num732];
                dust.velocity *= 7f;
                num732 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
            ...
            for (int num733 = 0; num733 < 2; num733 = num3 + 1)
            {
                ...
                int num734 = Gore.NewGore(new Vector2(projectile.position.X, projectile.position.Y), default(Vector2),
                ...
                num734 = Gore.NewGore(new Vector2(projectile.position.X, projectile.position.Y), default(Vector2),
                    Main.rand.Next(61, 64), 1f);
