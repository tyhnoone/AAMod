...
namespace AAMod.Projectiles
{
    public class DeathDagger : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                projectile.rotation =
                    (float) Math.Atan2((double) projectile.velocity.Y, (double) projectile.velocity.X) + 1.57f;
            }
            ...
            if (Main.rand.Next(6) == 0)
            {
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height,
                    mod.DustType<Dusts.AbyssDust>(), projectile.velocity.X * 0.5f, projectile.velocity.Y * 0.5f);
            }
        }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num304 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 100, default(Color), 0.8f);
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            Projectile.NewProjectile(target.position.X, target.position.Y, 0f, 0f,
                mod.ProjectileType("DeathDaggerHeal"), 0, 0f, projectile.owner, (float) num2, num);
        }
    }
}