...
namespace AAMod.Projectiles
{
    ...
    class TitanAxeEX : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                int num30 = Dust.NewDust(vector14 - projectile.Size / 2f, projectile.width, projectile.height, 63,
                    projectile.velocity.X, projectile.velocity.Y, 100, new Color(Main.DiscoR, 0, Main.DiscoB), 2f);
