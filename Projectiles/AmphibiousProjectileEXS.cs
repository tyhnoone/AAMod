    ...
    class AmphibiousProjectileEXS : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int dustId = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y + 2f), projectile.width,
                projectile.height + 5, mod.DustType<Dusts.InfinityOverloadP>(), projectile.velocity.X * 0.2f,
        ...
        public override void Kill(int timeleft)
        {
            ...
            for (int m = 0; m < pieCut; m++)
            {
                int dustID = Dust.NewDust(new Vector2(projectile.Center.X - 1, projectile.Center.Y - 1), 2, 2,
                    mod.DustType<Dusts.InfinityOverloadP>(), 0f, 0f, 100, Color.White, 1.6f);
            ...
            {
                int dustID = Dust.NewDust(new Vector2(projectile.Center.X - 1, projectile.Center.Y - 1), 2, 2,
                    mod.DustType<Dusts.InfinityOverloadP>(), 0f, 0f, 100, Color.White, 2f);
