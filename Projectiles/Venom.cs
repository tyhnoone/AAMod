        ...
        public override void AI()
        {
            ...
            for (int num151 = 0; num151 < 3; num151++)
            {
                ...
                int num155 = Dust.NewDust(
                    ...
                    projectile.width - num154 * 2, projectile.height - num154 * 2, mod.DustType<Dusts.AcidDust>(), 0f,
            ...
            if (Main.rand.Next(8) == 0)
            {
                ...
                int num157 = Dust.NewDust(
                    ...
                    projectile.width - num156 * 2, projectile.height - num156 * 2, mod.DustType<Dusts.AcidDust>(), 0f,
