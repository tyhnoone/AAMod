...
namespace AAMod.Projectiles
{
    public class SingularityVortex : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spritebatch, Color lightColor)
        {
            ...
            BaseDrawing.DrawTexture(spritebatch, Vortex, 0, projectile.position, projectile.width, projectile.height,
                projectile.scale, RingRotation, 0, 1, frame, projectile.GetAlpha(GenericUtils.COLOR_GLOWPULSE), true);
