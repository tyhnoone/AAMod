...
namespace AAMod.Projectiles.GemShot
{
    class TopazShot : ModProjectile
    {
        ...
        {
            Lighting.AddLight(projectile.Center, ((255 - projectile.alpha) * 0.8f) / 255f,
                ((255 - projectile.alpha) * 0.4f) / 255f, ((255 - projectile.alpha) * 0f) / 255f);
            ...
            for (int num339 = 0; num339 < 4; num339++)
            {
                ...
                dust1 = Main.dust[
                    Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width,
                        projectile.height, mod.DustType<Dusts.AbyssDust>(), 0, 0, 0, Color.Yellow, 1f)];
