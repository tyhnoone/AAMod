...
namespace AAMod.Projectiles.GemShot
{
    class AmberShot : ModProjectile
    {
        ...
        {
            Lighting.AddLight(projectile.Center, ((255 - projectile.alpha) * 1f) / 255f,
                ((255 - projectile.alpha) * 0.7f) / 255f, ((255 - projectile.alpha) * 0f) / 255f);
            ...
            for (int num339 = 0; num339 < 16; num339++)
            {
                ...
                dust1 = Main.dust[
                    Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width,
                        projectile.height, mod.DustType<Dusts.AbyssDust>(), 0, 0, 0, Color.Orange, 1f)];
