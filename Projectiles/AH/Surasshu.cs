...
namespace AAMod.Projectiles.AH
{
    public class Surasshu : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num30 = Dust.NewDust(vector14 - projectile.Size / 2f, projectile.width, projectile.height,
                    mod.DustType<Dusts.AbyssDust>(), projectile.velocity.X, projectile.velocity.Y, 100, default(Color),
                    1f);
