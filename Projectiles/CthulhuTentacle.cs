    ...
    public class CthulhuTentacle : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.scale < 1f)
            {
                ...
                {
                    int num898 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y),
                        projectile.width, projectile.height, mod.DustType<Dusts.CthulhuAuraDust>(),
                        projectile.velocity.X, projectile.velocity.Y, 100, default(Color), 1.1f);
