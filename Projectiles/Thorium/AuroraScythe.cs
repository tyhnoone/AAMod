...
namespace AAMod.Projectiles.Thorium
{
    public class AuroraScythe : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.NewProjectile(projectile.Center.X + 20, projectile.Center.Y, -15f, 0f,
                mod.ProjectileType("AuroraScytheDamage"), projectile.damage, projectile.knockBack, projectile.owner, 0f,
                0f);
            Projectile.NewProjectile(projectile.Center.X - 20, projectile.Center.Y, 15f, 0f,
                mod.ProjectileType("AuroraScytheDamage"), projectile.damage, projectile.knockBack, projectile.owner, 0f,
                0f);
            ...
            {
                Projectile.NewProjectile(projectile.Center.X + 20, projectile.Center.Y, -15f, 0f,
                    mod.ProjectileType("AuroraScytheDamage2"), (int) (projectile.damage * .35), projectile.knockBack,
