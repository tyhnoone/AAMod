    ...
    public class SandSpray : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                int dustIndex =
                    Dust.NewDust(
                        new Vector2(projectile.position.X + (float) eggroll, projectile.position.Y + (float) eggroll),
                        projectile.width - eggroll * 2, projectile.height - eggroll * 2, 269, 0f, 0f, 100,
                        default(Color), 1f);
            ...
            if (Main.rand.Next(8) == 0)
            {
                ...
                int dustIndex2 =
                    Dust.NewDust(
                        new Vector2(projectile.position.X + (float) eggplant, projectile.position.Y + (float) eggplant),
                        projectile.width - eggplant * 2, projectile.height - eggplant * 2, 269, 0f, 0f, 100,
                        default(Color), 0.5f);
