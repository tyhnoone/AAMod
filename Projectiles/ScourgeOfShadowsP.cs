...
namespace AAMod.Projectiles
{
    public class ScourgeOfShadowsP : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(30) == 0)
            {
                for (int num627 = 0; num627 < 2; num627++)
                {
                    ...
                    num628 *= 10f;
                    num629 *= 10f;
                    int p = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, num628, num629, 307,
                        projectile.damage, (float) ((int) ((double) projectile.knockBack * 0.35)), Main.myPlayer, 0f,
                        0f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num623 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 184, 0f, 0f, 0, default(Color), 1f);
            ...
            {
                int num625 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 184, 0f, 0f, 0, default(Color), 1f);
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                for (int num627 = 0; num627 < num626; num627 = num3 + 1)
                {
                    ...
                    num629 *= 10f;
                    int p = Projectile.NewProjectile(projectile.position.X, projectile.position.Y, num628, num629, 307,
                        projectile.damage * 3, (float) ((int) ((double) projectile.knockBack * 0.35)), Main.myPlayer,
                        0f, 0f);
                    num3 = num627;
