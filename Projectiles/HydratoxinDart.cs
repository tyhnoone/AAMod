    ...
    public class HydratoxinDart : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] > (float) Main.rand.Next(5, 20))
            {
                ...
                projectile.ai[1] = 0f;
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 8f,
                    mod.ProjectileType("HydratoxinDrop"), projectile.damage / 2, projectile.knockBack * 0.5f,
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            for (int k = 0; k < projectile.oldPos.Length; k++)
            {
                ...
                spriteBatch.Draw(Main.projectileTexture[projectile.type], drawPos, null, color, projectile.rotation,
