    ...
    public class PonyBoomEX2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            while ((float) num462 < num461)
            {
                ...
                num463 *= num466;
                num464 *= num466;
                int num467 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.AbyssDust>(), 0f, 0f, 100, Main.DiscoColor, 1.5f);
