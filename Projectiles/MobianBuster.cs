    ...
    public class MobianBuster : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (projectile.ai[1] == 1f && projectile.ai[0] != 1f)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    int num5 = Dust.NewDust(value - Vector2.One * 8f, 16, 16, 55, projectile.velocity.X / 2f,
            ...
            if (projectile.owner == Main.myPlayer)
            {
                ...
                switch (chargeLevel)
                {
                    case 0:
                        ...
                        Projectile.NewProjectile(vector2.X, vector2.Y, SpeedX, SpeedY, mod.ProjectileType("MobianShot"),
                            projectile.damage, 1f, player.whoAmI);
                        break;
                    case 1:
                        Main.PlaySound(2, (int) projectile.position.X, (int) projectile.position.Y, 89);
                        Projectile.NewProjectile(vector2.X, vector2.Y, SpeedX, SpeedY, mod.ProjectileType("MobianShot"),
                    ...
                    case 3:
                        ...
                        Projectile.NewProjectile(vector2.X, vector2.Y, SpeedX, SpeedY,
                            mod.ProjectileType("MobianShotCharged"), projectile.damage * 6, 1f, player.whoAmI);
                        break;
                }
            }
        }
