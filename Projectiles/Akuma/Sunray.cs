    ...
    public class Sunray : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            for (int num808 = 0; num808 < 2; num808++)
            {
                ...
                Vector2 vector73 = new Vector2((float) Math.Cos((double) num809) * num810,
                    (float) Math.Sin((double) num809) * num810);
            ...
            {
                Vector2 value38 = projectile.velocity.RotatedBy(1.5707963705062866, default(Vector2)) *
                                  ((float) Main.rand.NextDouble() - 0.5f) * (float) projectile.width;
                int num812 = Dust.NewDust(vector72 + value38 - Vector2.One * 4f, 8, 8, 31, 0f, 0f, 100, default(Color),
                    1.5f);
