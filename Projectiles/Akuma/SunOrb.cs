    ...
    public class SunOrb : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Dust dust31 =
                    Main.dust[
                        Dust.NewDust(projectile.Center - vector135 * 30f, 0, 0, mod.DustType<Dusts.AkumaADust>(), 0f,
            ...
            if (Main.rand.Next(2) == 0)
            {
                ...
                Dust dust32 =
                    Main.dust[
                        Dust.NewDust(projectile.Center - vector136 * 30f, 0, 0, mod.DustType<Dusts.AkumaADust>(), 0f,
                            0f, 0, default(Color), 1f)];
            ...
            if (projectile.ai[0] < 0f)
            {
                ...
                int num1059 = Dust.NewDust(center15 - Vector2.One * 8f, 16, 16, mod.DustType<Dusts.AkumaADust>(),
                    projectile.velocity.X / 2f, projectile.velocity.Y / 2f, 0, default(Color), 1f);
            ...
            if (projectile.ai[0] == 0f)
            {
                ...
                if (ownerMinionAttackTargetNPC6 != null && ownerMinionAttackTargetNPC6.CanBeChasedBy(this, false))
                {
                    ...
                    if (num1062 < num1061 && Collision.CanHitLine(projectile.Center, 0, 0,
                            ownerMinionAttackTargetNPC6.Center, 0, 0))
                    {
                        num1061 = num1062;
            ...
            if (projectile.ai[0] > 0f)
            {
                ...
                if (projectile.ai[0] >= num1066)
                {
                    ...
                    {
                        Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector137.X, vector137.Y,
                            mod.ProjectileType("Sunray"), projectile.damage, projectile.knockBack, projectile.owner, 0f,
                            (float) projectile.whoAmI);
                    }
                }
            }
        }
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Rotation += .0008f;
            BaseDrawing.DrawTexture(spriteBatch, mod.GetTexture("Projectiles/Akuma/SunOrb"), 0,
                projectile.position + new Vector2(0, projectile.gfxOffY), projectile.width, projectile.height,
                projectile.scale, projectile.rotation, projectile.spriteDirection, 1, SunFrame, GetAlpha(Color.White),
                true);
            return false;
        }
    }
