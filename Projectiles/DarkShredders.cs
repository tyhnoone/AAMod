    ...
    Projectiles //We need this to basically indicate the folder where it is to be read from, so you the texture will load correctly
{
    public class DarkShredders : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(projectile.Center, 0f, .5f,
                .100f); //this is the projectile light color R, G, B (Red, Green, Blue)
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height,
                DustID.Electric); //this is the dust that this projectile will spawn
