...
namespace AAMod.Projectiles
{
    public class AncientArcanum : ModProjectile
    {
            ...
            if (num1013 == 0)
            {
                ...
                if (Main.rand.Next(3) == 0)
                {
                    if (Main.rand.Next(2) == 0)
                    {
                        ...
                        Dust dust28 = Main.dust[Dust.NewDust(projectile.Center - vector140 * 30f, 0, 0,
                    ...
                    else
                    {
                        ...
                        Dust dust29 =
                            Main.dust[
                                Dust.NewDust(projectile.Center - vector141 * 30f, 0, 0, 236, 0f, 0f, 0, default(Color),
                                    1f)];
            ...
            else if (num1013 == 1)
            {
                ...
                for (int num1014 = 0; num1014 < 1; num1014 = num3 + 1)
                {
                    if (Main.rand.Next(2) == 0)
                    {
                        ...
                        Dust dust30 =
                            Main.dust[
                                Dust.NewDust(projectile.Center - vector142 * 30f, 0, 0, 88, 0f, 0f, 0, default(Color),
                                    1f)];
                        ...
                        dust30 = Main.dust[
                            Dust.NewDust(projectile.Center - vector142 * 30f, 0, 0, 92, 0f, 0f, 0, default(Color), 1f)];
                        dust30.noGravity = true;
                        dust30.position = projectile.Center - vector142 * (float) Main.rand.Next(10, 21);
                        dust30.velocity = vector142.RotatedBy(1.5707963705062866, default(Vector2)) * 6f;
                        dust30.scale = 0.9f + Main.rand.NextFloat();
                    ...
                    else
                    {
                        ...
                        Dust dust31 =
                            Main.dust[
                                Dust.NewDust(projectile.Center - vector143 * 30f, 0, 0, 236, 0f, 0f, 0, default(Color),
                                    1f)];
                ...
                if (projectile.ai[0] % 30f == 0f && projectile.ai[0] < 241f && Main.myPlayer == projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, vector144.X, vector144.Y, 618,
                        projectile.damage / 2, 0f, projectile.owner, 0f, (float) projectile.whoAmI);
                }
                ...
                if (projectile.ai[1] == 0f)
                {
                    for (int num1017 = 0; num1017 < 200; num1017 = num3 + 1)
                    {
                        if (Main.npc[num1017].CanBeChasedBy(projectile, false))
                        {
                            ...
                            if (projectile.Distance(center13) < num1015 && Collision.CanHit(
                                    new Vector2(projectile.position.X + (float) (projectile.width / 2),
                                        projectile.position.Y + (float) (projectile.height / 2)), 1, 1,
                                    Main.npc[num1017].position, Main.npc[num1017].width, Main.npc[num1017].height))
                            {
                ...
                if (projectile.ai[1] != 0f)
                {
                    ...
                    if (Main.npc[num1018].active && Main.npc[num1018].CanBeChasedBy(projectile, true) &&
                        projectile.Distance(Main.npc[num1018].Center) < 1000f)
                    {
                        flag59 = true;
                ...
                if (flag59)
                {
                    float num1019 = 4f;
                    int num1020 = 8;
                    Vector2 vector146 = new Vector2(projectile.position.X + (float) projectile.width * 0.5f,
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num96 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 236, 0f, 0f, 100, default(Color), 1.5f);
                Main.dust[num96].position = projectile.Center + Vector2.UnitY.RotatedByRandom(3.1415927410125732) *
                                            (float) Main.rand.NextDouble() * (float) projectile.width / 2f;
                num3 = num95;
            }

            for (int num97 = 0; num97 < 30; num97 = num3 + 1)
            {
                int num98 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 59, 0f, 0f, 200, default(Color), 3.7f);
                Main.dust[num98].position = projectile.Center + Vector2.UnitY.RotatedByRandom(3.1415927410125732) *
                                            (float) Main.rand.NextDouble() * (float) projectile.width / 2f;
                Main.dust[num98].noGravity = true;
                Dust dust = Main.dust[num98];
                dust.velocity *= 3f;
                num98 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 92, 0f, 0f, 100, default(Color), 1.5f);
                Main.dust[num98].position = projectile.Center + Vector2.UnitY.RotatedByRandom(3.1415927410125732) *
                                            (float) Main.rand.NextDouble() * (float) projectile.width / 2f;
            ...
            {
                int num100 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 59, 0f, 0f, 0, default(Color), 2.7f);
                Main.dust[num100].position = projectile.Center +
                                             Vector2.UnitX.RotatedByRandom(3.1415927410125732)
                                                 .RotatedBy((double) projectile.velocity.ToRotation(),
                                                     default(Vector2)) * (float) projectile.width / 2f;
            ...
            {
                int num102 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, 236, 0f, 0f, 0, default(Color), 1.5f);
                Main.dust[num102].position = projectile.Center +
                                             Vector2.UnitX.RotatedByRandom(3.1415927410125732)
                                                 .RotatedBy((double) projectile.velocity.ToRotation(),
                                                     default(Vector2)) * (float) projectile.width / 2f;
            ...
            {
                int num104 = Gore.NewGore(
                    projectile.position + new Vector2((float) (projectile.width * Main.rand.Next(100)) / 100f,
                        (float) (projectile.height * Main.rand.Next(100)) / 100f) - Vector2.One * 10f, default(Vector2),
                    Main.rand.Next(61, 64), 1f);
                Main.gore[num104].position = projectile.Center + Vector2.UnitY.RotatedByRandom(3.1415927410125732) *
                                             (float) Main.rand.NextDouble() * (float) projectile.width / 2f;
                Gore gore = Main.gore[num104];
                gore.velocity *= 0.3f;
                Gore expr_3C56_cp_0_cp_0 = Main.gore[num104];
                expr_3C56_cp_0_cp_0.velocity.X =
                    expr_3C56_cp_0_cp_0.velocity.X + (float) Main.rand.Next(-10, 11) * 0.05f;
                Gore expr_3C81_cp_0_cp_0 = Main.gore[num104];
                expr_3C81_cp_0_cp_0.velocity.Y =
                    expr_3C81_cp_0_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11) * 0.05f;
                num3 = num103;
            }
            ...
            if (Main.myPlayer == projectile.owner)
            {
                ...
                {
                    if (Main.projectile[num105].active && Main.projectile[num105].type == 618 &&
                        Main.projectile[num105].ai[1] == (float) projectile.whoAmI)
                    {
                ...
                for (int num110 = 0; num110 < num106; num110 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(vector4.X, vector4.Y, vector5.X, vector5.Y, 620,
                        (int) ((double) projectile.damage * 0.65), projectile.knockBack * 0.8f, projectile.owner,
                        (float) num108, 0f);
                    num3 = num110;
                }
                ...
                for (int num111 = 0; num111 < num107; num111 = num3 + 1)
                {
                    ...
                    Projectile.NewProjectile(vector6.X, vector6.Y, vector7.X, vector7.Y, 620,
                        (int) ((double) projectile.damage * 0.65), projectile.knockBack * 0.8f, projectile.owner,
                        (float) num109, 0f);
                    num3 = num111;
                }
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            arg_DA77_0.Draw(arg_DA77_1, arg_DA77_2, sourceRectangle2, color58, -projectile.rotation + 0.35f, origin8,
                scale13, spriteEffects ^ SpriteEffects.FlipHorizontally, 0f);
            SpriteBatch arg_DAC3_0 = Main.spriteBatch;
            Texture2D arg_DAC3_1 = Main.extraTexture[50];
            Vector2 arg_DAC3_2 = vector53;
            sourceRectangle2 = null;
            arg_DAC3_0.Draw(arg_DAC3_1, arg_DAC3_2, sourceRectangle2, alpha4, -projectile.rotation, origin8,
                projectile.scale, spriteEffects ^ SpriteEffects.FlipHorizontally, 0f);
            SpriteBatch arg_DB13_0 = Main.spriteBatch;
            Texture2D arg_DB13_1 = texture2D31;
            Vector2 arg_DB13_2 = vector53;
            sourceRectangle2 = null;
            arg_DB13_0.Draw(arg_DB13_1, arg_DB13_2, sourceRectangle2, color57, -projectile.rotation * 0.7f, origin8,
                projectile.scale, spriteEffects ^ SpriteEffects.FlipHorizontally, 0f);
            SpriteBatch arg_DB72_0 = Main.spriteBatch;
            Texture2D arg_DB72_1 = Main.extraTexture[50];
            Vector2 arg_DB72_2 = vector53;
            sourceRectangle2 = null;
            arg_DB72_0.Draw(arg_DB72_1, arg_DB72_2, sourceRectangle2, alpha4 * 0.8f, projectile.rotation * 0.5f,
                origin8, projectile.scale * 0.9f, spriteEffects, 0f);
            alpha4.A = 0;
        }
