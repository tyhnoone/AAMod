        ...
        public override void Kill(int timeLeft)
        {
            for (int num468 = 0; num468 < 20; num468++)
            {
                int num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width, 1,
                    mod.DustType<Dusts.AkumaADust>(), -projectile.velocity.X * 0.2f,
            ...
            if (TileHit)
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y + 20, projectile.velocity.X,
                    projectile.velocity.Y, mod.ProjectileType("MeteorStrikeBlue"), projectile.damage,
            ...
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y + 20, projectile.velocity.X,
                    projectile.velocity.Y, mod.ProjectileType("MeteorBoomBlue"), projectile.damage,
                    projectile.knockBack, projectile.owner, 0f, 0f);
            }
        }
