...
namespace AAMod.NPCs.TownNPCs
{
    ...
    public class Samurai : ModNPC
    {
        ...
        {
            get { return new string[] {"AAMod/NPCs/TownNPCs/SamuraiParty"}; }
        }
        ...
        public override string GetChat()
        {
            ...
            {
                chat.Add("I've known " + Main.npc[TravellingMerchant].GivenName +
                         " for a while. He's quite the man of culture.");
            }

            int DD2Bartender = NPC.FindFirstNPC(NPCID.DD2Bartender);
            if (DD2Bartender >= 0 && Main.rand.Next(4) == 0)
            {
                return "I'm not really a fan of " + Main.npc[DD2Bartender].GivenName +
                       "'s ale. It's a bit strong for my taste. I prefer Sake to be entirely honest.";
            }
            ...
            chat.Add(
                "I remember my old master giving me wise words such as: 'YOU ARE TRYING TO VIEW FLASH CONTENT BUT YOU DO NOT HAVE A FLASH PLAYER INSTALLED'... I’m still trying to figure that one out.");
