...
namespace AAMod.NPCs.TownNPCs
{
    ...
    public class GoblinSlayer : ModNPC
    {
        ...
        {
            get { return "AAMod/NPCs/TownNPCs/GoblinSlayer"; }
        }
        ...
        public override string GetChat()
        {
            ...
            {
                chat.Add("I don't trust " + Main.npc[Goblin].GivenName +
            ...
            {
                return Main.npc[DD2Bartender].GivenName +
                       " tells me that where he's from, they kill goblins a lot. I wish to visit this place sometime. Sounds glorious.";
            }
            ...
            chat.Add(
                "Hey, while you're out there, can you kill some goblins for me? Give me their souls and I'll trade you for some of my extra goblin slaying gear.");
            return chat;
        }
