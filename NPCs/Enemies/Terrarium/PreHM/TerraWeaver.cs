...
namespace AAMod.NPCs.Enemies.Terrarium.PreHM
{
    public class TerraWeaver : ModNPC
    {
        ...
        {
            get { return "AAMod/NPCs/Enemies/Terrarium/PreHM/TerraWeaver"; }
        }
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                if (npc.ai[0] == 0)
                {
                    ...
                    {
                        latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType<TerraWeaverBody>(),
                            npc.whoAmI, 0, latestNPC);
                        Main.npc[(int) latestNPC].realLife = npc.whoAmI;
                        Main.npc[(int) latestNPC].ai[3] = npc.whoAmI;
                    }

                    latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType<TerraWeaverTail>(),
                        npc.whoAmI, 0, latestNPC);
                    Main.npc[(int) latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int) latestNPC].ai[3] = npc.whoAmI;
    ...
    public class TerraWeaverBody : TerraWeaver
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Enemies/Terrarium/PreHM/TerraWeaverBody"; }
        }
    ...
    public class TerraWeaverTail : TerraWeaver
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Enemies/Terrarium/PreHM/TerraWeaverTail"; }
        }
