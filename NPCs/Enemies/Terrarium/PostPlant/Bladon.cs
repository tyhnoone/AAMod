        ...
        public override void AI()
        {
            ...
            if (npc.ai[2] == 0f)
            {
                if (((Main.player[npc.target].Center.X < npc.Center.X && npc.direction < 0) ||
                     (Main.player[npc.target].Center.X > npc.Center.X && npc.direction > 0)) &&
            ...
            if (Main.player[npc.target].Center.Y + 100f < npc.position.Y && Collision.CanHit(npc.position, npc.width,
                ...
                if (Main.netMode != 1)
                {
                        ...
                        Collision.CanHitLine(npc.Center, 0, 0, Main.player[npc.target].Center, 0, 0))
                    {
                        ...
                        for (int num86 = 0; num86 < 4; num86++)
                        {
                            ...
                            Projectile.NewProjectile(vector13.X, vector13.Y, vector15.X, vector15.Y, 577, num85, 1f,
                                Main.myPlayer, 0f, 0f);
                        }
                    }
                }
