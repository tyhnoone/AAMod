...
namespace AAMod.NPCs.Enemies.Terrarium.PostPlant
{
    public class Minion3 : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            BaseAI.ShootPeriodic(npc, player.position, player.width, player.height, mod.ProjType("SummonBlast"),
        ...
        public void FireMagic(NPC npc, Vector2 velocity)
        {
            Player player = Main.player[npc.target];
            BaseAI.ShootPeriodic(npc, player.position, player.width, player.height, mod.ProjType("SummonBlast"),
                ref shootAI[0], 5, (int) (npc.damage * (Main.expertMode ? 0.25f : 0.5f)), 24f, true,
                new Vector2(20f, 15f));
        }
