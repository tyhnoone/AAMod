...
namespace AAMod.NPCs.Enemies.Terrarium.PostPlant
{
    public class SummonBlast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust dust20 =
                Main.dust[
                    Dust.NewDust(projectile.position, projectile.width, projectile.height,
                        mod.DustType<Dusts.SummonDust>(), 0f, 0f, 0, default(Color), 1f)];
            ...
            dust20 = Main.dust[
                Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType<Dusts.SummonDust>(),
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num468 = 0; num468 < 20; num468++)
            {
                int num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.SummonDust>(), -projectile.velocity.X * 0.2f,
