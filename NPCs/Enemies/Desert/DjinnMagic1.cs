...
namespace AAMod.NPCs.Enemies.Desert
{
    public class DjinnMagic1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num86 = Dust.NewDust(position, num84, height3, mod.DustType<Dusts.InfinityOverloadB>(), 0f, 0f, 100,
                    default(Color), 1.2f);
        ...
        public override void Kill(int timeleft)
        {
            ...
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.velocity.X,
                projectile.velocity.Y, mod.ProjectileType("DjinnBurst1"), projectile.damage, projectile.knockBack,
