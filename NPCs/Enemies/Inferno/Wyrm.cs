...
namespace AAMod.NPCs.Bosses.Wyrm
{
    public class Wyrm : ModNPC
    {
        ...
        {
            get { return "AAMod/NPCs/Enemies/Inferno/WyrmHead"; }
        }
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                if (npc.ai[0] == 0)
                {
                    ...
                    {
                        latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType("WyrmBody1"),
                    ...
                    latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType("WyrmBody2"), npc.whoAmI,
                        0, latestNPC);
                    Main.npc[(int) latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int) latestNPC].ai[3] = npc.whoAmI;

                    latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType("WyrmBody3"), npc.whoAmI,
                        0, latestNPC);
                    Main.npc[(int) latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int) latestNPC].ai[3] = npc.whoAmI;

                    latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType("WyrmBody4"), npc.whoAmI,
                        0, latestNPC);
                    Main.npc[(int) latestNPC].realLife = npc.whoAmI;
                    Main.npc[(int) latestNPC].ai[3] = npc.whoAmI;
        ...
        public override void NPCLoot()
        {
            ...
            Item.NewItem((int) npc.position.X, (int) npc.position.Y, npc.width, npc.height, ItemID.SoulofFlight,
    ...
    public class WyrmBody1 : Wyrm
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Enemies/Inferno/WyrmBody1"; }
        }
        ...
        public override bool PreAI()
        {
            ...
            if (Main.npc[(int) npc.ai[1]].alpha < 128)
            {
                if (npc.alpha != 0)
                {
                    ...
                    {
                        int num935 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height,
                            mod.DustType("WyrmADust"), 0f, 0f, 100, default(Color), 2f);
    ...
    public class WyrmBody2 : Wyrm
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Enemies/Inferno/WyrmBody2"; }
        }
    ...
    public class WyrmBody3 : Wyrm
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Enemies/Inferno/WyrmBody3"; }
        }
    ...
    public class WyrmBody4 : Wyrm
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Enemies/Inferno/WyrmBody4"; }
        }
