    ...
    public class Miregron : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            if (npc.life > 0)
            {
                ...
                {
                    int num590 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.AcidDust>(), 0f,
                        0f, 0, default(Color), 1.5f);
            ...
            {
                int num592 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.AcidDust>(), 0f, 0f,
