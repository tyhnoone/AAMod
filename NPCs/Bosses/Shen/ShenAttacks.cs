    ...
    public class ShenAttacks
    {
        ...
        public static void Dragonfire(NPC npc, Mod mod)
        {
            ...
            for (int num120 = 0; num120 < 3; num120++)
            {
                ...
                Projectile.NewProjectile(vector2.X, vector2.Y, speedX5, speedY6,
                    mod.ProjectileType<NPCs.Bosses.Shen.DiscordianInferno>(), npc.damage / 4, 6, Main.myPlayer);
            }
        }
        ...
        public static void Eruption(NPC npc, Mod mod)
        {
            ...
            Projectile.NewProjectile(vector2.X, vector2.Y, 0, num115 * 1.5f, mod.ProjectileType("ShenMeteor1"),
