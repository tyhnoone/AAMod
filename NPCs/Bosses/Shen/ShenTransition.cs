...
namespace AAMod.NPCs.Bosses.Shen
{
    public class ShenTransition : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] == 820)
            {
                Main.NewText("Have you forgotten about our last battles...?", Color.DarkMagenta.R, Color.DarkMagenta.G,
                    Color.DarkMagenta.B);
            }

            if (npc.ai[0] == 960)
            {
                Main.NewText("There's always a last stand, kiddo...", Color.DarkMagenta.R, Color.DarkMagenta.G,
                    Color.DarkMagenta.B);
            }
            ...
            if (npc.ai[0] == 1100)
            {
                Main.NewText("I have only been using a fraction of my true power...and now...heheheh…",
        ...
        public void SummonShen()
        {
            ...
            Main.NewText("YOU WILL BURN IN THE FLAMES OF DISCORDIAN HELL!!!", Color.DarkMagenta.R, Color.DarkMagenta.G,
                Color.DarkMagenta.B);
            if (Main.netMode != 1)
            {
