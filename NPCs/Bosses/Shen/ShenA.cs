    ...
    public class ShenA : ShenDoragon
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            if (npc.life <= npc.lifeMax * 0.9f && !Health9)
            {
                ...
                {
                    BaseUtility.Chat("I must say, child. You impress me.", Color.DarkMagenta.R, Color.DarkMagenta.G,
                        Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat("Face it, child! You’ll never defeat the living embodiment of disarray itself!",
            ...
            if (npc.life <= npc.lifeMax * 0.8f && !Health8)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("You fight, even when the odds are stacked against you.", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat("You’re still going? How amusing...", Color.DarkMagenta.R, Color.DarkMagenta.G,
                        Color.DarkMagenta.B);
                }
            ...
            if (npc.life <= npc.lifeMax * 0.7f && !Health7)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("You remind me of myself quite a bit, to be honest...", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat("Putting up a fight when you know Death is inevitable...", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
            ...
            if (npc.life <= npc.lifeMax * 0.6f && !Health6)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("Maybe some day, you'll have your own realm to rule over...", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat("Now stop making this hard! Stand still and take it like a man!",
                        Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
            ...
            if (npc.life <= npc.lifeMax * 0.4f && !Health4)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("But today, we clash! Now show me what you got!", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat("DIE ALREADY YOU INSIGNIFICANT LITTLE WORM!!", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
            ...
            if (npc.life <= npc.lifeMax * 0.2f && !Health3)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("Still got it? I'm impressed. Show me your true power!", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat(
                        "WHAT?! HOW HAVE YOU- ENOUGH! YOU WILL KNOW WHAT IT MEANS TO FEEL UNYIELDING CHAOS!",
                        Color.DarkMagenta.R, Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
            ...
            if (npc.life <= npc.lifeMax * 0.1f && !Health2)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("Come on! KEEP PUSHING!", Color.DarkMagenta.R, Color.DarkMagenta.G,
                        Color.DarkMagenta.B);
                }
                else
                {
                    BaseUtility.Chat("NO! I WILL NOT LOSE! NOT TO YOU!", Color.DarkMagenta.R, Color.DarkMagenta.G,
                        Color.DarkMagenta.B);
                }
            ...
            if (npc.life <= npc.lifeMax * 0.05f && !Health1)
            {
                if (AAWorld.downedShen)
                {
                    BaseUtility.Chat("SHOW ME! SHOW ME THE TRUE POWER YOU HOLD!", Color.DarkMagenta.R,
                        Color.DarkMagenta.G, Color.DarkMagenta.B);
                }
                else
                {
        ...
        public override bool PreDraw(SpriteBatch sb, Color drawColor)
        {
            ...
            if (Charging)
            {
                BaseDrawing.DrawAfterimage(sb, currentTex, 0, npc, 1.5f, 1f, 3, false, 0f, 0f,
                    new Color(drawColor.R, drawColor.G, drawColor.B, (byte) 150));
            }
            ...
            BaseDrawing.DrawTexture(sb, currentWingTex, 0, npc.position + new Vector2(0, npc.gfxOffY), npc.width,
                npc.height, npc.scale, npc.rotation, npc.spriteDirection, 5, wingFrame, drawColor);
