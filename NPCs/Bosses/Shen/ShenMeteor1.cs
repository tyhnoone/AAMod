...
namespace AAMod.NPCs.Bosses.Shen
{
    public class ShenMeteor1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            dust20 = Main.dust[
                Dust.NewDust(projectile.position, projectile.width, projectile.height, mod.DustType<Dusts.Discord>(),
            ...
            for (int num189 = 0; num189 < 1; num189++)
            {
                int num190 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.Discord>(), 0f, 0f, 0, default(Color), 1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num336 = 0; num336 < 8; num336++)
            {
                Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.Discord>(), 0f, 0f, 100, default(Color), 1.5f);
            }
            ...
            for (int num337 = 0; num337 < 32; num337++)
            {
                int num338 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.Discord>(), 0f, 0f, 100, default(Color), 2.5f);
            ...
            for (int num341 = 0; num341 < 5; num341++)
            {
                ...
                int num343 = Dust.NewDust(projectile.position, projectile.width, projectile.height, num342,
                    2.5f * (float) projectile.direction, -2.5f, 0, default(Color), 1f);
