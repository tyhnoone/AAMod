...
namespace AAMod.NPCs.Bosses.Shen
{
    public class Shenling : ModNPC
    {
        ...
        {
            get { return "AAMod/NPCs/Bosses/Shen/Shenling"; }
        }
            ...
            if (Main.netMode != 1)
            {
                if (npc.ai[0] == 0f)
                {
                    ...
                    for (int l = 0; l < 10; l++)
                    {
                        ...
                        int SpawnBody1 = NPC.NewNPC((int) (npc.position.X + (float) (npc.width / 2)),
                            (int) (npc.position.Y + (float) npc.height), Body1, npc.whoAmI, 0f, 0f, 0f, 0f, 255);
                        ...
                        int SpawnBody2 = NPC.NewNPC((int) (npc.position.X + (float) (npc.width / 2)),
                            (int) (npc.position.Y + (float) npc.height), Body2, npc.whoAmI, 0f, 0f, 0f, 0f, 255);
        ...
        public override void NPCLoot()
        {
            for (int num468 = 0; num468 < 3; num468++)
            {
                int num469 = Dust.NewDust(new Vector2(npc.Center.X, npc.Center.Y), npc.width, 1,
                    mod.DustType<Dusts.DiscordLight>(), -npc.velocity.X * 0.2f,
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            ...
            for (int k = 0; k < npc.oldPos.Length; k++)
            {
                ...
                spriteBatch.Draw(Trail, drawPos, null, color, npc.rotation, drawOrigin, npc.scale, SpriteEffects.None,
                    0f);
            }
    ...
    public class ShenlingBody1 : Shenling
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Bosses/Shen/ShenlingBody1"; }
        }
                ...
                if (npc.alpha != 0)
                {
                    for (int num934 = 0; num934 < 2; num934++)
                    {
                        int num935 = Dust.NewDust(new Vector2(npc.position.X, npc.position.Y), npc.width, npc.height,
                            mod.DustType("DiscordLight"), 0f, 0f, 100, default(Color), 2f);
    ...
    public class ShenlingBody2 : Shenling
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Bosses/Shen/ShenlingBody2"; }
        }
    ...
    public class ShenlingTail : Shenling
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Bosses/Shen/ShenlingTail"; }
        }
