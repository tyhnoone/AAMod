...
namespace AAMod.NPCs.Bosses.Shen
{
    public class DiscordianFlare : ModProjectile
    {
        ...
        {
            Lighting.AddLight(projectile.Center, ((255 - projectile.alpha) * 0.9f) / 255f,
                ((255 - projectile.alpha) * 0f) / 255f, ((255 - projectile.alpha) * 0.9f) / 255f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                for (i = 0; i < 4; i++)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y,
                        ...
                        mod.ProjectileType("DiscordianInferno"), projectile.damage, projectile.knockBack,
            ...
            for (int dust = 0; dust <= 5; dust++)
            {
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height,
                    mod.DustType<Dusts.Discord>(), projectile.oldVelocity.X * 0.5f, projectile.oldVelocity.Y * 0.5f);
            }
        }
    }
}