...
namespace AAMod.NPCs.Bosses.Zero
{
    public class Taser : ModNPC
    {
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                int ind = NPC.NewNPC((int) (npc.position.X + (double) (npc.width / 2)),
                    (int) npc.position.Y + (npc.height / 2), mod.NPCType("TeslaHand"), npc.whoAmI, -2f, npc.ai[1], 0f,
                    0f, byte.MaxValue);
                Main.npc[ind].life = 1;
        ...
        public override void AI()
        {
            ...
            float num1 = (float) (Main.npc[(int) npc.ai[1]].position.X +
                                  (double) (Main.npc[(int) npc.ai[1]].width / 2) - (200.0 * npc.ai[0])) - vector2_1.X;
            ...
            if (npc.ai[2] == 99.0)
            {
                ...
                if (npc.position.X + (double) (npc.width / 2) > Main.npc[(int) npc.ai[1]].position.X +
                    (double) (Main.npc[(int) npc.ai[1]].width / 2))
                {
            ...
            else if (npc.ai[2] == 0.0 || npc.ai[2] == 3.0)
            {
                ...
                if (Main.npc[(int) npc.ai[1]].ai[1] != 0.0)
                {
                    ...
                    {
                        Vector2 vector2_2 = new Vector2(npc.position.X + (npc.width * 0.5f),
                ...
                else
                {
                    ...
                    if (npc.position.X + (double) (npc.width / 2) > Main.npc[(int) npc.ai[1]].position.X +
                        (double) (Main.npc[(int) npc.ai[1]].width / 2) + 250.0)
                    {
                        if (npc.velocity.X > 0.0)
                ...
                Vector2 vector2_4 = new Vector2(npc.position.X + (npc.width * 0.5f),
                    npc.position.Y + (npc.height * 0.5f));
                float num9 = (float) (Main.npc[(int) npc.ai[1]].position.X +
                                      (double) (Main.npc[(int) npc.ai[1]].width / 2) - (200.0 * npc.ai[0])) -
                             vector2_4.X;
            ...
            else if (npc.ai[2] == 1.0)
            {
                ...
                Vector2 vector2_2 = new Vector2(npc.position.X + (npc.width * 0.5f),
                    npc.position.Y + (npc.height * 0.5f));
                float num4 = (float) (Main.npc[(int) npc.ai[1]].position.X +
                                      (double) (Main.npc[(int) npc.ai[1]].width / 2) - (280.0 * npc.ai[0])) -
                             vector2_2.X;
            ...
            else if (npc.ai[2] == 4.0)
            {
                ...
                if (npc.velocity.X > 12.0)
                    npc.velocity.X = 12f;
                if (npc.position.X + (double) (npc.width / 2) >= Main.npc[(int) npc.ai[1]].position.X +
                    (double) (Main.npc[(int) npc.ai[1]].width / 2) - 500.0 &&
                    npc.position.X + (double) (npc.width / 2) <= Main.npc[(int) npc.ai[1]].position.X +
                    (double) (Main.npc[(int) npc.ai[1]].width / 2) + 500.0)
                    return;
                npc.TargetClosest(true);
                npc.ai[2] = 5f;
            ...
            {
                if (npc.ai[2] != 5.0 || npc.position.X + (double) (npc.width / 2) >=
                    Main.player[npc.target].position.X + (double) (Main.player[npc.target].width / 2) - 100.0)
                    return;
                if (npc.ai[3] >= 4.0)
                {
                    npc.ai[2] = 0.0f;
