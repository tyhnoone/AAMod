        ...
        public override void AI()
        {
            ...
            if (projectile.localAI[1] > 10f && Main.rand.Next(3) == 0)
            {
                ...
                for (int num694 = 0; num694 < num693; num694++)
                {
                    ...
                    int num695 = Dust.NewDust(vector56 + value24, 0, 0, 217, value24.X * 2f, value24.Y * 2f,
                        mod.DustType<Dusts.VoidDust>(), default(Color), 1.4f);
                ...
                for (int num698 = 0; num698 < 200; num698++)
                {
                    ...
                    if ((projectile.ai[0] == 0f || projectile.ai[0] == (float) (num698 + 1)))
                    {
                        ...
                        if (num699 < num697 && Collision.CanHit(projectile.position, projectile.width,
                                projectile.height, player.position, player.width, player.height))
                        {
                            num697 = num699;
                            vector57 = center4;
                            num696 = num698;
