...
using AAMod.NPCs.Bosses.Shadow.Yamata.Awakened;
using AAMod.NPCs.Bosses.Yamata;

namespace AAMod.NPCs.Bosses.Shadow.Yamata
{
    //[AutoloadBossHead]
    public class ShadowYamata : YamataBoss
	{
        public NPC TrueHead;
        public NPC Head2;
        public NPC Head3;
        ...
        public override void NPCLoot()
        {
            ...
            if (!Tag)
            {
                ...
                if (Main.expertMode)
                {
                    Projectile.NewProjectile((new Vector2(npc.Center.X, npc.Center.Y)), (new Vector2(0f, 0f)), mod.ProjectileType("ShadowYamataTransition"), 0, 0);
                }
                npc.value = 0f;
                npc.boss = false;
            }
            ...
            if (!HeadsSpawned)
            {
                if (Main.netMode != 1)
                {
					...
					if(isAwakened)
					{
						...
						latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y - 100, mod.NPCType("ShadowYamataAHead"), 0, npc.whoAmI);
					...
					{
						int latestNPC = npc.whoAmI;
						latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y - 100, mod.NPCType("ShadowYamataHead"), 0, npc.whoAmI);
						Main.npc[(int)latestNPC].realLife = npc.whoAmI;
						Main.npc[(int)latestNPC].ai[0] = npc.whoAmI;
						TrueHead = Main.npc[latestNPC];
						latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y - 100, mod.NPCType("ShadowYamataHeadF1"), 0, npc.whoAmI);
						Main.npc[(int)latestNPC].ai[0] = npc.whoAmI;
						...
						latestNPC = NPC.NewNPC((int)npc.Center.X, (int)npc.Center.Y - 100, mod.NPCType("ShadowYamataHeadF2"), 0, npc.whoAmI);
						Main.npc[(int)latestNPC].ai[0] = npc.whoAmI;
        ...
        public void DrawHead(SpriteBatch spriteBatch, string headTexture, string glowMaskTexture, NPC head, Color drawColor, bool DrawUnder)
        {
            ...
            {
				string neckTex = (isAwakened ? "NPCs/Bosses/Shadow/Yamata/Awakened/ShadowYamataANeck" : "NPCs/Bosses/Shadow/Yamata/ShadowYamataNeck");
        ...
        public override void PostDraw(SpriteBatch sb, Color dColor)
        {
            ...
            string tailTex = (isAwakened ? "NPCs/Bosses/Shadow/Yamata/Awakened/ShadowYamataATail" : "NPCs/Bosses/Shadow/Yamata/ShadowYamataTail");
			string headTex = (isAwakened ? "NPCs/Bosses/Shadow/Yamata/Awakened/ShadowYamataAHead" : "NPCs/Bosses/Shadow/Yamata/ShadowYamataHead");
            ...
            if (!isAwakened)
            {
                DrawHead(sb, "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF1", "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF1_Glow", Head2, dColor, false);
                DrawHead(sb, "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF1", "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF1_Glow", Head3, dColor, false);
                DrawHead(sb, "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF1", "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF1_Glow", Head4, dColor, false);
                DrawHead(sb, "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF2", "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF2_Glow", Head5, dColor, false);
                DrawHead(sb, "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF2", "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF2_Glow", Head6, dColor, false);
                DrawHead(sb, "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF2", "NPCs/Bosses/Shadow/Yamata/ShadowYamataHeadF2_Glow", Head7, dColor, false);
            }
    ...
    public class LimbInfo
    {
        ...
        public ShadowYamata yamata = null;
    }
    ...
    public class LegInfo : LimbInfo
    {
        ...
        public LegInfo(int lType, Vector2 initialPos, ShadowYamata m)
        {
            yamata = m;
            position = initialPos;
        ...
        public Vector2 GetStandOnPoint(NPC npc)
        {
            ...
            if (tileY - defaultTileY > ShadowYamata.flyingTileCount) { return default(Vector2); } //'flying' behavior
            if (!flying)
            {
        ...
        public void DrawLeg(SpriteBatch sb, NPC npc, Color dColor)
        {
            ...
            if (textures == null)
            { 
				string texRoot = "NPCs/Bosses/Shadow/Yamata/Yamata";
