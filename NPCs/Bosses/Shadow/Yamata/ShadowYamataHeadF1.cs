...
{
    [AutoloadBossHead]
    public class ShadowYamataHeadF1 : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Shadow of Yamata");
		...
		public ShadowYamata Body = null;
        public ShadowYamata Head = null;
        ...
        public override void AI()
		{
            if (Body == null)
            {
                ...
                if (npcBody.type == mod.NPCType<ShadowYamata>() || npcBody.type == mod.NPCType<YamataA>())
                {
                    Body = (ShadowYamata)npcBody.modNPC;
                }
                else if (npcBody.type == mod.NPCType<ShadowYamataHead>())
                {
                    Head = (ShadowYamata)npcBody.modNPC;
                    ...
                    Body = (ShadowYamata)RealBody.modNPC;
                    Head.Tag = true;
