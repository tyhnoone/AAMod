...
namespace AAMod.NPCs.Bosses.Raider
{
    public class RaidRocket : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] != 3f)
            {
                int num1008 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.FulguriteDust>(), 0f,
                    0f, 100, default(Color), 0.5f);
            ...
            else if (npc.ai[0] == 1f)
            {
                ...
                {
                    int num1015 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.FulguriteDust>(),
                        0f, 0f, 100, default(Color), 0.5f);
                    Main.dust[num1015].noGravity = true;
                    Main.dust[num1015].velocity *= 2f;
                    Main.dust[num1015].velocity = Main.dust[num1015].velocity / 2f +
                                                  Vector2.Normalize(Main.dust[num1015].position - npc.Center);
                }
            }
            else if (npc.ai[0] == 2f)
            {
            ...
            if (npc.ai[0] == 3f)
            {
                ...
                {
                    int num1018 = Dust.NewDust(npc.position, npc.width, npc.height, 31, 0f, 0f, 100, default(Color),
                        1.5f);
                ...
                {
                    int num1020 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.FulguriteDust>(),
                        0f, 0f, 100, default(Color), 0.5f);
                    ...
                    {
                        num1020 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.FulguriteDust>(),
                            0f, 0f, 100, default(Color), 0.9f);
                        Main.dust[num1020].noGravity = true;
        ...
        public override void HitEffect(int hitDirection, double damage)
        {
            ...
            {
                int num237 = Dust.NewDust(npc.position, npc.width, npc.height, mod.DustType<Dusts.FulguriteDust>(),
                    (float) (-1 * hitDirection), -1f, 0, default(Color), 1f);
        ...
        public override void NPCLoot()
        {
            if (TileHit)
            {
                Projectile.NewProjectile(npc.Center.X, npc.Center.Y + 20, npc.velocity.X, npc.velocity.Y,
                    mod.ProjectileType("RaidStrike"), npc.damage, 1, 255);
            }

            if (PlayerHit)
            {
                Projectile.NewProjectile(npc.Center.X, npc.Center.Y + 20, npc.velocity.X, npc.velocity.Y,
                    mod.ProjectileType("RaidBoom"), npc.damage, 1, 255);
            }
        }
