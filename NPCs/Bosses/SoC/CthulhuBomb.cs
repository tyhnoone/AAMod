...
{
    internal class CthulhuBomb : ModProjectile
    {
        ...
        public override void Kill(int timeleft)
        {
            ...
            if (PlayerHit)
            {
                Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y + 20, projectile.velocity.X, projectile.velocity.Y, mod.ProjectileType("CthulhuBoom"), projectile.damage, 1, 255);
            }
