...
namespace AAMod.NPCs.Bosses.SoC
{
    class CthulhuShot : ModProjectile
    {
        ...
        {
            target.AddBuff(mod.BuffType<Buffs.RealityBent>(), 1000);
        }
        ...
        public override void Kill(int timeleft)
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                if (projectile.ai[1] < 1f)
                {
                    ...
                    int num329 = Projectile.NewProjectile(projectile.Center.X - (float)(projectile.direction * 30), projectile.Center.Y - 4f, (float)(-(float)projectile.direction) * 0.01f, 0f, mod.ProjectileType<CthulhuHurricane>(), num328, 4f, projectile.owner, 16f, 15f);
                ...
                else
                {
                    ...
                    int num335 = Projectile.NewProjectile((float)(num331 * 16 + 8), (float)(num330 * 16 - 24), 0f, 0f, mod.ProjectileType<CthulhuHurricane>(), num334, 4f, Main.myPlayer, 16f, 24f);
