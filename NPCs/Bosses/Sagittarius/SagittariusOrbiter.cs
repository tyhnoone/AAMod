...
namespace AAMod.NPCs.Bosses.Sagittarius
{
    public class SagittariusOrbiter : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (sagittarius == null || sagittarius.life <= 0 || !sagittarius.active ||
                sagittarius.type != mod.NPCType("Sagittarius"))
            {
            ...
            if (Sagittarius.MovementType[0] == 0)
            {
                ...
                npc.Center = BaseUtility.RotateVector(sagittarius.Center, sagittarius.Center + new Vector2(140, 0f),
                    rotValue);
                ...
                BaseAI.ShootPeriodic(npc, player.position, player.width, player.height, mod.ProjType("DoomLaser"),
                    ref shootAI[0], aiTimerFire, (int) (npc.damage * (Main.expertMode ? 0.25f : 0.5f)), 10f, true,
                    new Vector2(20f, 15f));
            }
        ...
        public override bool PreDraw(SpriteBatch sb, Color dColor)
        {
            ...
            Vector2 endPoint = BaseUtility.RotateVector(npc.Center, npc.Center + new Vector2(-2f, 0),
            ...
            if (npc.alpha < 0)
            {
                BaseDrawing.DrawTexture(sb, mod.GetTexture("Glowmasks/SagittariusOrbiter_Glow"), 0, npc,
