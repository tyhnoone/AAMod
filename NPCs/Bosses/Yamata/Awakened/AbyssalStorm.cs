    ...
    public class AbyssalStorm : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Lighting.AddLight(projectile.Center, ((255 - projectile.alpha) * 0.9f) / 255f,
                ((255 - projectile.alpha) * 0f) / 255f, ((255 - projectile.alpha) * 0.4f) / 255f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if (projectile.owner == Main.myPlayer)
            {
                for (i = 0; i < 4; i++)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y,
                        ...
                        mod.ProjectileType("SoulRain"), projectile.damage, projectile.knockBack, projectile.owner, 0f,
                        0f);
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y,
                        (float) (-Math.Sin(offsetAngle) * 6f), (float) (-Math.Cos(offsetAngle) * 6f),
                        mod.ProjectileType("SoulRain"), projectile.damage, projectile.knockBack, projectile.owner, 0f,
            ...
            {
                Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 235,
