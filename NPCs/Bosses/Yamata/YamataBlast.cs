    ...
    public class YamataBlast : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            projectile.penetrate =
                1; //How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)
            projectile.timeLeft = 600; //The live time for the projectile (60 = 1 second, so 600 is 10 seconds)
            projectile.alpha = 20; //How much light emit around the projectile
            projectile.ignoreWater = true;
            projectile.tileCollide =
                true; //Set to above 0 if you want the projectile to update multiple time in a frame
        ...
        public override void Kill(int timeleft)
        {
            for (int num468 = 0; num468 < 20; num468++)
            {
                int num469 = Dust.NewDust(new Vector2(projectile.Center.X, projectile.Center.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.YamataDust>(), -projectile.velocity.X * 0.2f,
            ...
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y - 51 + 8, projectile.velocity.X,
                projectile.velocity.Y, mod.ProjectileType("Shock"), projectile.damage, projectile.knockBack,
