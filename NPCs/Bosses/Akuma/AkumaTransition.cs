    ...
    public class AkumaTransition : ModNPC
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            BaseDrawing.DrawTexture(spriteBatch, Main.npcTexture[npc.type], 0, npc.position, npc.width, npc.height,
                npc.scale, npc.rotation, npc.direction, 6, npc.frame, npc.GetAlpha(new Color(RVal, 125, BVal)), true);
            return false;
        }
        ...
        public override void AI()
        {
            ...
            if (npc.ai[0] >= 1165)
            {
                ...
                Main.NewText("IT ONLY MAKES THEM STRONGER!", Color.DeepSkyBlue.R, Color.DeepSkyBlue.G,
                    Color.DeepSkyBlue.B);
