...
namespace AAMod.NPCs.Bosses.Akuma.Awakened
{
    public class AkumaRock : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int num336 = 0; num336 < 8; num336++)
            {
                Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.AkumaADust>(), 0f, 0f, 100, new Color(255, Main.DiscoG, 0),
                    1.5f);
            }

            for (int num337 = 0; num337 < 32; num337++)
            {
                int num338 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.AkumaADust>(), 0f, 0f, 100, new Color(255, Main.DiscoG, 0),
                    2.5f);
                Main.dust[num338].noGravity = true;
                Main.dust[num338].velocity *= 3f;
                num338 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width,
                    projectile.height, mod.DustType<Dusts.AkumaDust>(), 0f, 0f, 100, new Color(255, Main.DiscoG, 0),
                    1.5f);
            ...
            for (int num341 = 0; num341 < 5; num341++)
            {
                ...
                int num343 = Dust.NewDust(projectile.position, projectile.width, projectile.height, num342,
                    2.5f * (float) projectile.direction, -2.5f, 0, new Color(255, Main.DiscoG, 0), 1f);
            ...
            Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X,
                projectile.velocity.Y, mod.ProjectileType("AkumaABoom"), projectile.damage, projectile.knockBack,
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            {
                "NPCs/Bosses/Akuma/Awakened/AkumaRock", "NPCs/Bosses/Akuma/Awakened/AkumaRock",
                "NPCs/Bosses/Akuma/Awakened/AkumaRock"
            });

            Texture2D Rock = mod.GetTexture(RockType);
            float rot = projectile.rotation;
            BaseMod.BaseDrawing.DrawTexture(spriteBatch, mod.GetTexture(RockType), 0, projectile,
