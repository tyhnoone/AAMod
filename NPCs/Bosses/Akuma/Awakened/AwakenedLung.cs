...
namespace AAMod.NPCs.Bosses.Akuma.Awakened
{
    public class AwakenedLung : ModNPC
    {
        ...
        {
            get { return "AAMod/NPCs/Bosses/Akuma/Awakened/AwakenedLung"; }
        }
        ...
        public override bool PreAI()
        {
            ...
            if (Main.netMode != 1)
            {
                if (npc.ai[0] == 0)
                {
                    ...
                    for (int i = 0; i < 12; ++i)
                    {
                        latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType("AwakenedLungBody"),
                            npc.whoAmI, 0, latestNPC);
                        Main.npc[latestNPC].realLife = npc.whoAmI;
                        Main.npc[latestNPC].ai[3] = npc.whoAmI;
                    }

                    latestNPC = NPC.NewNPC((int) npc.Center.X, (int) npc.Center.Y, mod.NPCType("AwakenedLungTail"),
                        npc.whoAmI, 0, latestNPC);
                    Main.npc[latestNPC].realLife = npc.whoAmI;
                    Main.npc[latestNPC].ai[3] = npc.whoAmI;
    ...
    public class AwakenedLungBody : AwakenedLung
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Bosses/Akuma/Awakened/AwakenedLungBody"; }
        }
    ...
    public class AwakenedLungTail : AwakenedLung
    {
        public override string Texture
        {
            get { return "AAMod/NPCs/Bosses/Akuma/Awakened/AwakenedLungTail"; }
        }
